...
function popup13() {
    CreativaPopup.create('username:<font class="contactding" onclick="allahm109kd(); allahm109kd2();" color="#FF0000"> xerticz</font> &#10084<br> <font style="color: #696969; font-size: smaller;">biolink: <a href="https://ammo.lol/xerticz" style="color: #ADD8E6;">me</a> </font>', 'Discord', '', {
        titleColor: '#6ffcff',
        textColor: '#b0b0b0'
    });
...
function allahm109kd() {
    navigator.clipboard.writeText("xerticz");
    setTimeout(function() {
